            ...
            <div class="row">
              ...
              <div class="owl-carousel2">
                ...
                <form method='post' action="search.php">
		            <div class="col-xs-10"> <input type="text" name="key" class="form-control" id="default" list="languages" placeholder="Search your medicines here..." />
	                  ...
	                  <span>You Searched for <b><br><?php echo $key; ?></b></span>
	               	  </h3>
                </div> 
              </div>
              <!--/.OWL CAROUSEL2 END-->
                                    ...
                                    <div class="col-md-12 col-sm-6">
                                        <div class="wrap-card">
                                            <div class="card">
                                                <h2 class="year">
                                                   <?php echo $key;
                                                    $sql = $link->query("SELECT * FROM `TABLE 1` where `medicine_name` = '".$key."' ORDER BY `medicine_name` ASC");											
                                                    $row = @mysqli_fetch_assoc($sql);
                                     				?>
                                                </h2>
                                                <p class="job">
                                                   <?php echo $row['medicine_company']; ?>
                                                </p>
                                                <p class="job">
                                                   <?php echo $row['price']; ?>
                                                </p>
                                                ...
                                                <div class="text-detail">
                                                    ...
                                                    <p>
                                                        <ul>
                                                            <li><?php echo $row['composition']; ?></li>
                                                        </ul>
                                                    </p>
                                                </div>
                                                <div class="text-detail">
